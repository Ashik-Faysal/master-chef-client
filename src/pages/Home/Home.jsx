          ...
          <div className="hero-content text-center text-neutral-content">
            ...
            <div className="max-w-md">
              ...
              <p className="mb-5 font-semibold">
                Master Chef is an online platform dedicated to providing
                culinary enthusiasts with access to the latest recipes, cooking
                tips, and techniques from top chefs around the world. Our
                website is designed to inspire and educate, with a focus on
